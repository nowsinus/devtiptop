...
class Manager {
    ...
    public function __construct() {
        ...
        add_filter( 'dokan_withdraw_method_additional_info', [ $this, 'mask_custom_withdraw_method' ], 10, 4 );
    }
     ...
     * @since 3.7.27
     *
     * @param string $method_info
     * @param string $method_key
     * @param string $payment_methods
     * @param string $no_information
     *
     * @return string
     */
    public function mask_custom_withdraw_method( $method_info, $method_key, $payment_methods, $no_information ) {
